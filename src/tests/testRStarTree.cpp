...
TEST_CASE("R*Tree: testInsertOverflowReInsertAndSplit")
{
	...
	REQUIRE( center[0] == (nextafterf(30.0, FLT_MAX) - 30)/2);
	REQUIRE( center[1] == (nextafterf(30.0, FLT_MAX) - 30)/2);
