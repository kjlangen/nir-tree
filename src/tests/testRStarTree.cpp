...
TEST_CASE("R*Tree: testBoundingBox")
{
	...
	testNode.entries.push_back(createBranchEntry( Rectangle(8.0, 1.0, 12.0, 5.0), nullptr));
	testNode.entries.push_back(createBranchEntry( Rectangle(12.0, -4.0, 16.0, -2.0), nullptr));
	testNode.entries.push_back(createBranchEntry( Rectangle(8.0, -6.0, 10.0, -4.0), nullptr));

	REQUIRE(testNode.boundingBox() == Rectangle(8.0, -6.0, 16.0, 5.0));

	// Test set two
	rstartree::Node testNode2 = rstartree::Node();
	testNode2.entries.push_back(createBranchEntry(Rectangle(8.0, 12.0, 10.0, 14.0), nullptr));
	testNode2.entries.push_back(createBranchEntry(Rectangle(10.0, 12.0, 12.0, 14.0), nullptr));
	testNode2.entries.push_back(createBranchEntry(Rectangle(12.0, 12.0, 14.0, 14.0), nullptr));
...
TEST_CASE("R*Tree: testChooseLeaf")
{
    ...
    rstartree::Node *leftChild0 = createFullLeafNode(3,5);
    rstartree::Node *leftChild1 = createFullLeafNode(3,5);
    rstartree::Node *leftChild2 = createFullLeafNode(3,5);
    rstartree::Node *rightChild0 = createFullLeafNode(3,5);
    rstartree::Node *rightChild1 = createFullLeafNode(3,5);
    rstartree::Node *rightChild2 = createFullLeafNode(3,5);
...
TEST_CASE("R*Tree: testReInsert")
{
	...
	// center is (0,0)
	rstartree::Node *cluster4a = new rstartree::Node();
	cluster4a->entries.push_back(Point(-10.0, -10.0));
	cluster4a->entries.push_back(Point(-10.0, 10.0));
	cluster4a->entries.push_back(Point(10.0, -10.0));
	cluster4a->entries.push_back(Point(10.0, 10.0));
	cluster4a->entries.push_back(Point(5.0, -5.0));
	cluster4a->level = 1;
